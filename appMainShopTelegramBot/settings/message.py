...
<b>Добро пожаловать в телеграм-бот BugsUp</b>
...
ТП используя телеграм-бота BugsUp,
в удобной интуитивной форме смогут без
особого труда принять заказ от клиента.
BugsUp поможет сформировать заказ
и в удобном виде адресует информацию кладовщику 
...
-<b>software engineers: - </b><i>({})</i>


<b>{}BugsUp original trademark</b>
